	...
	function on_show_page() {
		...
		<div id="modal-dialog-general" class="wrap">
			...
			<h2><?php echo $pagetitle; ?>
				<span style='padding-left: 50px'><a href="https://ylefebvre.home.blog/wordpress-plugins/modal-dialog/" target="modaldialog"><img src="<?php echo plugins_url( "/icons/btn_donate_LG.gif", __FILE__ ); ?>" /></a></span>
			</h2>
